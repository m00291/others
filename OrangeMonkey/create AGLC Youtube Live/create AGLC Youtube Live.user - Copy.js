...
(function() {
  ...
  let lastUrl = location.href;
    ...
    // Main function to run when URL matches
    function onUrlChange(url) {
        console.log('[Userscript] URL changed to:', url);
        if (url.includes('/channel/UC2LOYen89PZP3y36uYY4v7A/livestreaming')) {
            console.clear();
            console.log('------------------------------------------------------------------');
            console.log('------------------------------------------------------------------');
            console.log('[Userscript] Matched livestreaming page, running SelectTemplate...');
            SelectTemplate();
        }
    }
    ...
    // Initialization
    function init() {
        console.log('[Userscript] Initializing...');
        monkeyPatchHistory();
        listenForUrlChange();
